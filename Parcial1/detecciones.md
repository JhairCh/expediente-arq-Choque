...
4. S - Srp -> GestorDePedidos.ProcesarPedido() - El metodo hace varias tareas: calcula el descuento, guarda el pedido, muestra el comprobante y envia el correo. Tiene varias razones diferentes para cambiar.
